...
class ProductViewSetTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.product1 = Product.objects.create(name='Laptop', description='Gaming Laptop', category=self.category1, price=15000000)
        self.product2 = Product.objects.create(name='Book', description='Comedy Book', category=self.category2, price=98000)
        ...
        Review.objects.create(product=self.product2, rating=4, user_id=1)
